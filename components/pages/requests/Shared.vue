<template>
  ...
  <div class="space-y-3 my-4 lg:my-6 w-full">
    <div v-if="prayerRequests.length" class="grid gap-6 md:grid-cols-1">
      <GroupsRequestsCard v-for="prayerRequest in prayerRequests" :key="prayerRequest.id"
        :prayer-request="prayerRequest" :my-role-for-group="myRoleForGroup" @open-detail="viewPrayerRequestDetail"
        :group="group" />
    </div>
